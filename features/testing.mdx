...
- **Backtesting**: Backtesting uses the logged Phospho data to evaluate your app's performance. This is useful for testing the app's performance on historical data.
...
- **Evaluate**: Evaluate success and failure of the agent based on provided inputs.
- **Compare**: Compares the output of the agent with the old output, allowing for performance comparison.    
