---
title: Evaluation
description: 'Evaluation and scoring of your LLM app'
---
...
- In the webapp and **manually** override phospho's annotations 
- Trigger [the API endpoint](https://api.phospho.ai/v0/redoc#tag/Tasks/operation/post_flag_task_tasks__task_id__flag_post) to override phospho's annotations at scale  
...
In the phospho dashboard, you can annotate tasks as successful or unsuccessful. Go to the _Sessions_ tab and click on a session. You'll see the list of tasks in the session. Click on a task to annotate it. 
