...
5. The **[phosphobot teleoperation app](/examples/teleop)** is installed on your **Meta Quest 2, Pro, 3 or 3s**. 
    1. If you bought the [starter pack](https://robots.phospho.ai), you should have received a link to download the app. Please [reach out](mailto:contact@phospho.ai) if not. 
