...
5. The **[phosphobot teleoperation app](/examples/teleop)** is installed on your **Meta Quest 2, Pro, 3 or 3s**. 
    ...
    2. If you didn't buy our products, we still can provide access to the app for a reasonable fee to cover our development costs. [Reach out to the phospho team on Discord](https://discord.gg/cbkggY6NSK) to get access. 
