...
1. A **phosphobot server** set up and connected to the internet. [Learn how to set up your control module](/unboxings/dk1).
...
4. A **Meta Quest 2, Pro, 3 or 3s** with the phosphobot teleoperation app installed. [Purchase the app here](https://robots.phospho.ai/).
