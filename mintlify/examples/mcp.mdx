---
title: phospho MCP server
description: "Control your robot with natural language"
---
...
Think of it like a **USB-C port for AI**: you expose Python functions and data sources, and the model can plug in and use them.
...
- **Host / Client / Server architecture**
    - Host = the LLM tool (e.g. Claude)
    - Client = the MCP protocol connector
    - Server = your app exposing tools/resources
