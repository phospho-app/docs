...
### ACT (Action Chunking Transformer) (October 2024)
...
[OpenVLA](https://github.com/openvla/openvla?tab=readme-ov-file#getting-started) is a great repo that showcases a more advanced model designed for **complex robotics tasks**. The architecture of OpenVLA include a [Llama-2-7b](https://huggingface.co/meta-llama/Llama-2-7b) model (July 2023) that receives a prompt describing the task. This gives the model some common sense and allows it to generalize to new tasks.
...
### SmolVLA by Hugging Face (June 2025)
...
### RT-2 (July 2023) and AutoRT (January 2024) by Google DeepMind
