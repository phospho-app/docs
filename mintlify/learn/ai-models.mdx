...
<Info>Get access to the Meta Quest app [on the Meta Store](https://www.meta.com/en-gb/experiences/phospho-teleoperation/8873978782723478/) or [with a starter pack](https://robots.phospho.ai)</Info>
...
<Note>
 The dataset visualizer only works with `AVC1` video codec. If you used another codec, you may see black screens in the video preview.
