...
- The **phosphobot server is running** and connected to the **robot arm** and **camera**. 
- The **[phosphobot teleoperation app](/examples/teleop)** is installed on your **Meta Quest 2, Pro, 3 or 3s** 
...
5. Make sure the phosphobot server is running. Open a browser and access `localhost` or `phosphobot.local` if you're using the control module. Then go to the Admin settings.
...
<Warning>Ensure that you are connected to the same network as the phosphobot server.</Warning>  
