...
description: "Teleoperate a real robot"
---

<Info> Before continuing, make sure you have [installed the software](/installation) and completed the [quickstart](/quickstart). </Info>
...
- [Record your first dataset](/basic-usage/dataset-recording) with teleoperation and upload it to Hugging Face.
