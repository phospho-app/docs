...
<Info> 
  - Before continuing, make sure you have installed [the phosphobot software](/installation) and completed the [quickstart](/so-100/quickstart).
  - If you don't have a robot arm, you can get hardware [here](https://robots.phospho.ai/).
  - If you built your own robot arm, you should first [calibrate it](/so-100/quickstart#calibrate-the-robot).
 </Info>
...
1. Go to the interactive API docs on the phosphobot dashboard: [localhost/docs](localhost/docs). On the control module, the address [phosphobot.local/docs](http://phosphobot.local/docs). This page lets you send commands to the robot arm.
...
<Info>The Meta Quest connects to the phosphobot server through a shared WiFi connection. </Info>
...
<Info>Make sure the Meta Quest is connected to the same WiFi that the computer running the phosphobot server.</Info>
