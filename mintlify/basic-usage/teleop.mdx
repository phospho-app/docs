...
<Info> 
  - Before continuing, make sure you have installed [the phosphobot software](/installation) and completed the [quickstart](/quickstart).
  - If you don't have a robot arm, you can get hardware [here](https://robots.phospho.ai/).
  - If you built your own robot arm, you should first [calibrate it](/quickstart#calibrate-the-robot).
 </Info>
