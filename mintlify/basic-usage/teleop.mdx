...
<Note> Before continuing, make sure you have followed the [phosphobot installation guide](/installation). </Note>
...
- Record your **first dataset** with [teleoperation](/examples/teleop) and upload it to Hugging Face.
- [Train an AI model](/learn/ai-models).
