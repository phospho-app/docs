...
To control your robot, you need to install [phosphobot](/installation). Make sure the robot was [calibrated with phosphobot](/so-100/quickstart). -

<InstallCode/>

## How to control the SO-100 with a keyboard? How to control the SO-101 with a keyboard?
...
## How to control the SO-100 with a gamepad? How to control the SO-101 with a gamepad?
...
## How to control the SO-100 with the Meta Quest app? How to control the SO-101 with the Meta Quest app?
...
## How to control the SO-100 with a leader arm? How to control the SO-101 with a leader arm?
...
## How to control the SO-100 with the HTTP API? How to control the SO-101 with the HTTP API?
