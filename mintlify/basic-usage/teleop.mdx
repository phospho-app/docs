...
<Note>
  To control your robot, you need to install [phosphobot](/installation) and completed the [quickstart](/so-100/quickstart). -
  If you don't have a robot arm, you can get hardware [here](https://robots.phospho.ai/). If you built your own robot arm, you
