---
title: "Manipulate datasets"
description: "How to repair, merge, split and delete LeRobot datasets"
---

<Note>
  To manipulate datasets, you need to install [phosphobot](/installation) 
</Note>
...
You wil see all your local datasets. To download a dataset from the HuggingFace hub, click on the `Download dataset` button. It will be downloaded and added to your local datasets.
