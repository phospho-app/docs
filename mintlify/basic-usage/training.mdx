...
description: "How to train an AI model from a dataset you recorded"
---

So you just recorded a dataset and now you want to train an AI model to control your robot. 
