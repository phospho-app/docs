...
If you want to run offline tests, you can use the [phospho command line interface](/docs/cli). Results of the offline tests are also available in the AB test tab.
