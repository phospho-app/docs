---
title: "Quickstart with your SO-100"
...
- If you want to build your own SO-100 robot arm, you can follow the [assembly guide](https://robots.phospho.ai/docs/so-100/build).
- If you're looking to buy SO-100 robot arm already assembled, you can get a starter pack [on our shop](https://robots.phospho.ai).
...
<Info> If you change the cameras connected to the computer running the server, you have to restart the server. </Info>
