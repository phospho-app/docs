...
<img width="400" src="https://github.com/phospho-app/phospho/raw/dev/phospho_diagram.png"></img>

<Note>Looking to setup logging to the phospho hosted version? [Read this guide instead.](/docs/getting-started)</Note>
