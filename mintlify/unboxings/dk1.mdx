...
1. Accept the invitation to the Alpha program from Meta. After your order, you'll receive **a mail** with an invite to the Alpha program of the phospho teleop app. 
Follow the instructions in the email to link your Meta account to the Alpha program.

2. Make sure your Meta Quest is turned on and connected to Wifi. Once you’ve linked your account, the Meta Quest will automatically download the app. This can take a moment.
