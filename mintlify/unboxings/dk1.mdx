...
- **Robot arm**
    ...
    - 2x table clamps
- **Camera**
    - 1x Stereo vision camera in a case
...
3. Plug the _stereoscopic camera_ to one of the control module **front USB ports**.
4. Plug the control module to the **white** power supply (this goes into the USB-C port on the side of the control module).
