...
When you plugged the control module, its LED should be blinking green. This means it is in **hotspot** mode. We need to connect it to your home wifi.
...
4. Reload the page [phosphobot.local](http://phosphobot.local) to access the control module dashboard and send your first command.
