...
Now that you have phospshobot installed, let's set it up and start controlling your robot arm.
...
- If you built your own robot arm, you should first [calibrate it](/installation#support).
...
- Then, follow the [Linux (APT) setup guide](/installation#linux) to install the teleoperation server.

## Support

We're constantly shipping updates to improve your experience, add new features, and fix issues.

If you experience issues, [reach out to us on our Discord](https://discord.gg/cbkggY6NSK). We are happy to help!
