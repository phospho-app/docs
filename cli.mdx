...
Use the phospho CLI to run tests. 
...
1. It stores phospho credentials in your home directory: `~/.phospho/config.json`. Use the `config` command to see the stored credentials:
...
This command is equivalent to running `python phospho_testing.py` with the correct environment variables set.
...
<Card title="phospo testing module" href="/python/testing" icon="python">
