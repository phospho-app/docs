...
Get started with **phospho lab**, the core of phospho. This is what the hosted version of phospho is built on.
...
<Note>Looking to setup logging to the phospho hosted version? [Read this guide instead.](/getting-started)</Note>
