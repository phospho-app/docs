...
3. You can filter the messages you want to cluster by setting a date range, a specific tag, and more.
4. Click on the "Run clustering" button to start the clustering process. The process can take a few minutes depending on the size of your dataset.
