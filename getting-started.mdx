...
There are several ways to import your data to phospho. The easiest is to upload a file.
...
- other columns will be stored as *metadata* and can be used for filtering
...
<Note>
You need to have a **payment method** set up to run a clustering. Add a payment method in Settings and claim your free credits.
</Note>
...
The clustering will take some times to run. Once it's done, you will see the results on the page.
