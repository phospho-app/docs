...
You can start experimenting with phospho locally. See the [local quickstart](/local/quickstart) for more information.
How to get started with phospho cloud:
...
<Card title="Supabase guide" icon="bolt" href="integrations/supabase">
