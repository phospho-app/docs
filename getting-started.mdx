...
<CardGroup>
  <Card title="Automatic event detection" href="/guides/events">
    Define events relevant to you, phospho detect them and can warn you when
    they happen. **Take action.**
  </Card>
  <Card title="Automatic Evaluation" href="/guides/evaluation">
    phospho classify interactions as successes or failures according to **your
    own definition.**
  </Card>
  <Card title="User Feedback" href="/guides/user-feedback">
    Collect and attach user feedbacks to specific interactions. **All in one
    place.**
  </Card>
  <Card title="Review and Label" href="/guides/evaluation">
    Let your team review and annotate flagged interactions. **Collaborate with
