...
Language detection is based on the **input** of a task, so the task below will be flagged as english, despite the assistant answering in French.
...
In the Transcripts, you can **filter** your tasks by language to explore them.