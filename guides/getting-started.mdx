...
You can import a CSV/Excel file into phospho.

<Accordion title="How to import a CSV to phospho">
...
You can now drag and drop your CSV file or click on the box to select it.
...
<Info>
- Make sure that your CSV is a valid CSV file separated by a semicolon. 
...
<Accordion title="How to connect LangSmith to phospho">
...
<Accordion title="How to connect LangFuse to phospho">
