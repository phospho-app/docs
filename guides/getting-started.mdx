...
<Steps>
  ...
  <Step title="Import your data in a project">
    Import your data from a CSV file or from LangSmith. Or try phospho in [Google Colab](https://colab.research.google.com/drive/1Wv9KHffpfHlQCxK1VGvP_ofnMiOGK83Q)
  </Step>
...
At this point, in the header, to the right, look for the gears icon and click on it. 
