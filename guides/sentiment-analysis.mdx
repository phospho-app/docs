...
Detect the sentiment of your users. An automatic sentiment analysis is performed on the **input** of a task. This lets you know whether your users are happy, sad, or neutral.
