...
- By default, phospho **automatically** evaluate the task success or failure.
- In the webapp, you and your team can **manually annotate** tasks as a success or a failure
- In your app, gather **users' feedback** [using our integrations](/guides/user-feedback)

Additional annotations enhance the stats and further **continously improve** phospho's detection algorithms. 
