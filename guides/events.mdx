...
description: "phospho looks for events in every interaction to warn you when needed"
---
...
Go to the **Insights/Events** tab of the [phospho dashboard](https://platform.phospho.ai/), and click Add Event on the right.

You will find some event templates like Coherence and Plausibility to get you started.

![Events tab](../images/guides/events%20detection/Create%20event.png)
...
![Event suggestion](../images/guides/events%20detection/Event%20suggestion.png)
...
Retrieve the task using the `task_id` and the [phospho API.](https://api.phospho.ai/v2/redoc#tag/Tasks/operation/get_task_tasks__task_id__get)
