---
title: Import a file in CSV or Excel format
...
Default evaluators like language and sentiment will be run on your messages. To create more events and to run them on your data, see the [event detection page](/guides/events)
